...
public class DraggableView extends RelativeLayout {
    ...
    void changeDragViewPosition() {
        dragView.setPivotX(dragView.getWidth() - getDragViewMarginRight());
        dragView.setPivotY(dragView.getHeight() - getDragViewMarginBottom());
    }
    ...
    void changeDragViewScale() {
        ...
        if (listener != null) {
			listener.onDraggableViewScaleChanged(1 - getVerticalDragOffset() / xScaleFactor, 1 - getVerticalDragOffset() / yScaleFactor);
		}
    }
